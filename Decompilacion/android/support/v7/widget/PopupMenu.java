...
public class PopupMenu {
    ...
    class C01782 implements android.widget.PopupWindow.OnDismissListener {
        C01782() {
        }
    ...
    class C02461 implements Callback {
        C02461() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0156R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C02461());
        ...
        this.mPopup.setOnDismissListener(new C01782());
    }
