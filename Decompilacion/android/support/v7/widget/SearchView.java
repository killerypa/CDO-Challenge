...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01834 implements OnFocusChangeListener {
        C01834() {
        }
    ...
    class C01845 implements OnLayoutChangeListener {
        C01845() {
        }
    ...
    class C01856 implements OnGlobalLayoutListener {
        C01856() {
        }
    ...
    class C01867 implements OnClickListener {
        C01867() {
        }
    ...
    class C01878 implements OnKeyListener {
        C01878() {
        }
    ...
    class C01889 implements OnEditorActionListener {
        C01889() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02481());
        boolean isIconified;

        static class C02481 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02481() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0156R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0156R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01801();
        this.mUpdateDrawableStateRunnable = new C01812();
        this.mReleaseCursorRunnable = new C01823();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01867();
        this.mTextKeyListener = new C01878();
        this.mOnEditorActionListener = new C01889();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0156R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0156R.styleable.SearchView_layout, C0156R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0156R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0156R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0156R.id.search_plate);
        this.mSubmitArea = findViewById(C0156R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0156R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0156R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0156R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0156R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0156R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0156R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0156R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0156R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0156R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0156R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0156R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0156R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0156R.styleable.SearchView_searchHintIcon);
        ViewCompat.setTooltipText(this.mSearchButton, getResources().getString(C0156R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0156R.styleable.SearchView_suggestionRowLayout, C0156R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0156R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01834());
        setIconifiedByDefault(a.getBoolean(C0156R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0156R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0156R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0156R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0156R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0156R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0156R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01845());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01856());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0156R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0156R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0156R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0156R.dimen.abc_dropdownitem_text_padding_left) : 0;
