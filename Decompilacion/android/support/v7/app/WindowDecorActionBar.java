...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02551();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02562();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02393();

    class C02393 implements ViewPropertyAnimatorUpdateListener {
        C02393() {
        }
    ...
    class C02551 extends ViewPropertyAnimatorListenerAdapter {
        C02551() {
        }
    ...
    class C02562 extends ViewPropertyAnimatorListenerAdapter {
        C02562() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0156R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0156R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0156R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0156R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0156R.styleable.ActionBar, C0156R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0156R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0156R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0156R.attr.actionBarWidgetTheme, outValue, true);
