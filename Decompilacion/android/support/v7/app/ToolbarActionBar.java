...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02382();
    private final Runnable mMenuInvalidator = new C01551();
    ...
    class C02382 implements OnMenuItemClickListener {
        C02382() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0156R.layout.abc_list_menu_item_layout);
