...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00401();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02042();

    static class C00401 implements ThreadFactory {
    ...
    class C02042 extends WorkerRunnable<Params, Result> {
        C02042() {
        }
