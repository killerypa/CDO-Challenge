...
public class MediaSessionCompat {
    ...
    class C02141 extends Callback {
        C02141() {
        }
    }

    class C02152 extends Callback {
        C02152() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02161();
        ...
        class C02161 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02161() {
            }
