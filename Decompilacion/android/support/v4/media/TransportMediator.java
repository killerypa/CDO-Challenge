...
public class TransportMediator extends TransportController {
    ...
    class C00752 implements Callback {
        C00752() {
        }
    ...
    class C02121 implements TransportMediatorCallback {
        C02121() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C02121();
        this.mKeyEventCallback = new C00752();
