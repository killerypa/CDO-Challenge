...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01131();
    ...
    private static final Interpolator sInterpolator = new C01142();
    ...
    private final Runnable mEndScrollRunnable = new C01153();
    ...
    static class C01131 implements Comparator<ItemInfo> {
        C01131() {
        }
    ...
    static class C01142 implements Interpolator {
        C01142() {
        }
    ...
    class C02234 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02234());
    }
